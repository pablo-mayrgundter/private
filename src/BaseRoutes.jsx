 ...
 *
 *   http://host/<install_path>/<app>/<view>/<object>
 *
 * which when fully expanded becomes:
 *
 *   http://host/<install_path>/share/v/p/indec.ifc
 *   http://host/<install_path>/share/v/gh/bldrs-ai/Share/main/public/index.ifc
 *
